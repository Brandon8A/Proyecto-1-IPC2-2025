<%-- 
    Document   : crudComponentes
    Created on : 12 mar 2025, 18:45:45
    Author     : brandon
--%>
    ...
    <body class="flex h-screen bg-gray-100">
        ...
        <div class="flex-1 flex flex-col">
            ...
            <header class="bg-white shadow-md p-4 flex justify-between items-center">
                <h1 class="text-xl font-bold">Modificar Componentes</h1>
            ...
            <main class="flex-1 p-6">
                <div class="bg-white p-6 shadow rounded-lg">
                    <div class="contenedor">
                        <form action="crearComponenteAdmin.jsp" method="post">
                            <button type="submit" class="btn btn-primary">Agrear nuevo componente</button>
                        </form>
                    </div>
                            ...
                            <tbody>
                                <%
                                    try {
                                        ...
                                        resultSet = statement.executeQuery("SELECT id_pieza, nombre_pieza FROM Pieza WHERE eliminado = FALSE;");
