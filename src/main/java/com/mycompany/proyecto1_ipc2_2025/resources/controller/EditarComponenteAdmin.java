 ...
 * @author brandon
 */
@WebServlet(name = "EditarComponenteAdmin", urlPatterns = {"/EditarComponenteAdmin"})
public class EditarComponenteAdmin extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            connection.getStatement().executeUpdate("UPDATE Pieza SET nombre_pieza = '" + componente + "' WHERE id_pieza = '" + idComponente + "';");
