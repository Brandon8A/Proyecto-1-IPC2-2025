<%-- 
    Document   : ensablar
    Created on : 12 mar 2025, 23:48:26
    Author     : brandon
--%>
...
<html>
    <head>
        ...
        <title>Usuario Area Ensamble</title>
    </head>
    <body class="flex h-screen bg-gray-100">
        ...
        <aside class="w-64 bg-gray-800 text-white flex flex-col">
            ...
            <nav class="flex-1 p-4">
                <a href="../ensamblarComputadora.jsp" class="block px-4 py-2 rounded-lg hover:bg-gray-700">Ensamblar</a>
            </nav>
        ...
        <div class="flex-1 flex flex-col">
            ...
            <header class="bg-white shadow-md p-4 flex justify-between items-center">
                <h1 class="text-xl font-bold">Area de Ensamble</h1>
            ...
            <main class="flex-1 p-6">
                <div class="bg-white p-6 shadow rounded-lg">
                    <h2 class="text-2xl font-bold mb-4">Bienvenido al Panel de Ensamble</h2>
